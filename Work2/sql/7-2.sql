...
CREATE TABLE `app_product` (
  ...
  `valid` char(2) DEFAULT NULL COMMENT '有效【0：关闭 1：有效】',
  `rank` varchar(10) DEFAULT NULL COMMENT '顺序',
...
CREATE TABLE `app_proposer` (
  ...
  `telephone` varchar(20) NOT NULL COMMENT '固定电话（公司电话）',
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'DEV-PC1562061497117', '1562061545321', '15000');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', null, '1562061500000', '-1', '5', 'PAUSED', 'CRON', '1562061497000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', null, '1562061500000', '-1', '5', 'PAUSED', 'CRON', '1562061497000', '0', null, '2', '');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-07-02 17:27:56', 'admin', '2018-03-16 11:33:00', 'ry', '2019-07-02 17:27:56', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('8f95eadd-825c-4003-93f9-cce6c188c69a', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', 'on_line', '2019-07-02 17:27:54', '2019-07-02 17:48:10', '1800000');
