...
INSERT INTO `app_product` VALUES ('16', 'app', '15日', '8888', '4444', null, '版权局', '王俊凯', '19874563215', '1152053244', '1000', null, '是啊', null, null);
...
-- ----------------------------
INSERT INTO `app_product_type` VALUES ('1', '软著', '12315');
INSERT INTO `app_product_type` VALUES ('2', '商标', '32521');
INSERT INTO `app_product_type` VALUES ('3', '小说', '465789');
INSERT INTO `app_product_type` VALUES ('4', '图片', '123');
INSERT INTO `app_product_type` VALUES ('5', '剧本', '1456');
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'MAITIAN-design1566452315327', '1566452484446', '15000');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', null, '1566452320000', '-1', '5', 'PAUSED', 'CRON', '1566452315000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', null, '1566452320000', '-1', '5', 'PAUSED', 'CRON', '1566452315000', '0', null, '2', '');
...
CREATE TABLE `sys_logininfor` (
  ...
  PRIMARY KEY (`info_id`)
) ENGINE=InnoDB AUTO_INCREMENT=291 DEFAULT CHARSET=utf8 COMMENT='系统访问记录';
...
INSERT INTO `sys_logininfor` VALUES ('283', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-08-22 08:59:21');
INSERT INTO `sys_logininfor` VALUES ('284', 'admin', '192.168.1.100', '内网IP', 'Microsoft Edge', 'Windows 10', '0', '登录成功', '2019-08-22 09:08:29');
INSERT INTO `sys_logininfor` VALUES ('285', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-08-22 10:48:24');
INSERT INTO `sys_logininfor` VALUES ('286', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-08-22 11:18:52');
INSERT INTO `sys_logininfor` VALUES ('287', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-08-22 11:19:36');
INSERT INTO `sys_logininfor` VALUES ('288', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-08-22 11:27:15');
INSERT INTO `sys_logininfor` VALUES ('289', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-08-22 13:31:15');
INSERT INTO `sys_logininfor` VALUES ('290', 'admin', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', '0', '登录成功', '2019-08-22 13:38:47');
...
INSERT INTO `sys_menu` VALUES ('2002', '项目', '0', '3', '#', 'menuItem', 'M', '0', '', 'fa fa-handshake-o', 'admin', '2019-07-01 15:01:10', 'admin', '2019-08-22 11:52:59', '');
INSERT INTO `sys_menu` VALUES ('2004', '产品信息管理', '2000', '1', '/copyright/appProduct', 'menuItem', 'C', '0', 'copyright:appProduct:view', '#', 'admin', '2019-07-01 15:07:17', 'admin', '2019-08-22 09:14:38', '');
...
INSERT INTO `sys_menu` VALUES ('2071', '种类', '2000', '2', '/copyright/appProductType', 'menuItem', 'C', '0', 'copyright:appProductType:view', '#', 'admin', '2019-08-22 09:21:14', 'admin', '2019-08-22 11:29:12', '');
...
CREATE TABLE `sys_oper_log` (
  ...
  PRIMARY KEY (`oper_id`)
) ENGINE=InnoDB AUTO_INCREMENT=550 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';
...
INSERT INTO `sys_oper_log` VALUES ('537', '产品', '1', 'com.ruoyi.web.controller.copyright.AppProductController.addSave()', '1', 'admin', null, '/copyright/appProduct/add', '127.0.0.1', '内网IP', '{\r\n  \"type\" : [ \"app\" ],\r\n  \"workdays\" : [ \"15日\" ],\r\n  \"salesPrice\" : [ \"8888\" ],\r\n  \"purchasePrice\" : [ \"4444\" ],\r\n  \"supplierCompany\" : [ \"版权局\" ],\r\n  \"supplierName\" : [ \"王俊凯\" ],\r\n  \"supplierPhone\" : [ \"19874563215\" ],\r\n  \"supplierQq\" : [ \"1152053244\" ],\r\n  \"award\" : [ \"1000\" ],\r\n  \"remark\" : [ \"是啊\" ]\r\n}', '0', null, '2019-08-22 09:06:45');
INSERT INTO `sys_oper_log` VALUES ('538', '菜单管理', '2', 'com.ruoyi.web.controller.system.SysMenuController.editSave()', '1', 'admin', null, '/system/menu/edit', '127.0.0.1', '内网IP', '{\r\n  \"menuId\" : [ \"2004\" ],\r\n  \"parentId\" : [ \"2000\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"产品信息管理\" ],\r\n  \"url\" : [ \"/copyright/appProduct\" ],\r\n  \"target\" : [ \"menuBlank\" ],\r\n  \"perms\" : [ \"copyright:appProduct:view\" ],\r\n  \"orderNum\" : [ \"1\" ],\r\n  \"icon\" : [ \"#\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', '0', null, '2019-08-22 09:13:59');
INSERT INTO `sys_oper_log` VALUES ('539', '菜单管理', '2', 'com.ruoyi.web.controller.system.SysMenuController.editSave()', '1', 'admin', null, '/system/menu/edit', '127.0.0.1', '内网IP', '{\r\n  \"menuId\" : [ \"2004\" ],\r\n  \"parentId\" : [ \"2000\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"产品信息管理\" ],\r\n  \"url\" : [ \"/copyright/appProduct\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"copyright:appProduct:view\" ],\r\n  \"orderNum\" : [ \"1\" ],\r\n  \"icon\" : [ \"#\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', '0', null, '2019-08-22 09:14:38');
INSERT INTO `sys_oper_log` VALUES ('540', '菜单管理', '1', 'com.ruoyi.web.controller.system.SysMenuController.addSave()', '1', 'admin', null, '/system/menu/add', '127.0.0.1', '内网IP', '{\r\n  \"parentId\" : [ \"2000\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"种类\" ],\r\n  \"url\" : [ \"/copyright/appProduct/productType\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"copyright:appProduct:view\" ],\r\n  \"orderNum\" : [ \"2\" ],\r\n  \"icon\" : [ \"\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', '0', null, '2019-08-22 09:21:14');
INSERT INTO `sys_oper_log` VALUES ('541', '代码生成', '8', 'com.ruoyi.generator.controller.GenController.genCode()', '1', 'admin', '研发部门', '/tool/gen/genCode/app_product_type', '127.0.0.1', '内网IP', '{ }', '0', null, '2019-08-22 11:22:08');
INSERT INTO `sys_oper_log` VALUES ('542', '菜单管理', '2', 'com.ruoyi.web.controller.system.SysMenuController.editSave()', '1', 'admin', '研发部门', '/system/menu/edit', '127.0.0.1', '内网IP', '{\r\n  \"menuId\" : [ \"2071\" ],\r\n  \"parentId\" : [ \"2000\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"种类\" ],\r\n  \"url\" : [ \"/copyright/productType\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"copyright:appProductType:view\" ],\r\n  \"orderNum\" : [ \"2\" ],\r\n  \"icon\" : [ \"#\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', '0', null, '2019-08-22 11:28:17');
INSERT INTO `sys_oper_log` VALUES ('543', '菜单管理', '2', 'com.ruoyi.web.controller.system.SysMenuController.editSave()', '1', 'admin', '研发部门', '/system/menu/edit', '127.0.0.1', '内网IP', '{\r\n  \"menuId\" : [ \"2071\" ],\r\n  \"parentId\" : [ \"2000\" ],\r\n  \"menuType\" : [ \"C\" ],\r\n  \"menuName\" : [ \"种类\" ],\r\n  \"url\" : [ \"/copyright/appProductType\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"copyright:appProductType:view\" ],\r\n  \"orderNum\" : [ \"2\" ],\r\n  \"icon\" : [ \"#\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', '0', null, '2019-08-22 11:29:12');
INSERT INTO `sys_oper_log` VALUES ('544', '产品类型', '1', 'com.ruoyi.web.controller.copyright.AppProductTypeController.addSave()', '1', 'admin', '研发部门', '/copyright/appProductType/add', '127.0.0.1', '内网IP', '{\r\n  \"productType\" : [ \"软著\" ],\r\n  \"price\" : [ \"12315\" ]\r\n}', '0', null, '2019-08-22 11:29:49');
INSERT INTO `sys_oper_log` VALUES ('545', '产品类型', '1', 'com.ruoyi.web.controller.copyright.AppProductTypeController.addSave()', '1', 'admin', '研发部门', '/copyright/appProductType/add', '127.0.0.1', '内网IP', '{\r\n  \"productType\" : [ \"商标\" ],\r\n  \"price\" : [ \"32521\" ]\r\n}', '0', null, '2019-08-22 11:30:40');
INSERT INTO `sys_oper_log` VALUES ('546', '产品类型', '1', 'com.ruoyi.web.controller.copyright.AppProductTypeController.addSave()', '1', 'admin', null, '/copyright/appProductType/add', '127.0.0.1', '内网IP', '{\r\n  \"productType\" : [ \"小说\" ],\r\n  \"price\" : [ \"465789\" ]\r\n}', '0', null, '2019-08-22 11:52:16');
INSERT INTO `sys_oper_log` VALUES ('547', '菜单管理', '2', 'com.ruoyi.web.controller.system.SysMenuController.editSave()', '1', 'admin', null, '/system/menu/edit', '127.0.0.1', '内网IP', '{\r\n  \"menuId\" : [ \"2002\" ],\r\n  \"parentId\" : [ \"0\" ],\r\n  \"menuType\" : [ \"M\" ],\r\n  \"menuName\" : [ \"项目\" ],\r\n  \"url\" : [ \"#\" ],\r\n  \"target\" : [ \"menuItem\" ],\r\n  \"perms\" : [ \"\" ],\r\n  \"orderNum\" : [ \"3\" ],\r\n  \"icon\" : [ \"fa fa-handshake-o\" ],\r\n  \"visible\" : [ \"0\" ]\r\n}', '0', null, '2019-08-22 11:52:59');
INSERT INTO `sys_oper_log` VALUES ('548', '产品类型', '1', 'com.ruoyi.web.controller.copyright.AppProductTypeController.addSave()', '1', 'admin', '研发部门', '/copyright/appProductType/add', '127.0.0.1', '内网IP', '{\r\n  \"productType\" : [ \"图片\" ],\r\n  \"price\" : [ \"123\" ]\r\n}', '0', null, '2019-08-22 13:31:34');
INSERT INTO `sys_oper_log` VALUES ('549', '产品类型', '1', 'com.ruoyi.web.controller.copyright.AppProductTypeController.addSave()', '1', 'admin', '研发部门', '/copyright/appProductType/add', '127.0.0.1', '内网IP', '{\r\n  \"productType\" : [ \"剧本\" ],\r\n  \"price\" : [ \"1456\" ]\r\n}', '0', null, '2019-08-22 13:31:51');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-08-22 13:38:47', 'admin', '2018-03-16 11:33:00', 'ry', '2019-08-22 13:38:47', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('6a5837d3-993d-461d-a604-380edab3e86e', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Chrome', 'Windows 7', 'on_line', '2019-08-22 13:31:14', '2019-08-22 13:38:47', '1800000');
