...
public class AppProductTypeController extends BaseController
{
	...
	@RequestMapping("/all")
	@ResponseBody
	public  AjaxResult all(AppProductType appProductType){ 
        AjaxResult ajax = new AjaxResult();
		List<AppProductType> listAppProductType = appProductTypeService.selectAppProductTypeList(appProductType);
		ajax.put("code", 200);
        ajax.put("value", listAppProductType);
        return ajax;
    }
	/**
	 * 导出产品类型列表
